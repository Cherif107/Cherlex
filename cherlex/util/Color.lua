...
local Bit = require 'cherlex.math.Bit'
...
function Color.fromRGB(red, green, blue, alpha) -- (Convert RGB To Color)
    local color = Color()
    if type(red) == 'table' then
        color.red = red.r or red.R or red.Red or red.RED or red.red or 255
        color.green = red.g or red.G or red.Green or red.GREEN or red.green or 255
        color.blue = red.b or red.B or red.Blue or red.BLUE or red.blue or 255
        color.alpha = red.a or red.A or red.Alpha or red.ALPHA or red.alpha or 255
    else
        color.red, color.green, color.blue, color.alpha = red or 255, green or 255, blue or 255, alpha or 255
    end
    return color
end
